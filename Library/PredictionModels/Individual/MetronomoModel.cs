...
namespace LotoLibrary.PredictionModels.Individual
{
    ...
    public partial class MetronomoModel : PredictionModelBase, IConfigurableModel, IExplainableModel
    {
        ...
        public List<FeatureImportance> GetFeatureImportances()
        {
            ...
            {
                new FeatureImportance { FeatureName = "Intervalos Históricos", Importance = 0.4, Type = FeatureType.Temporal },
                new FeatureImportance { FeatureName = "Tendência Atual", Importance = 0.3, Type = FeatureType.Pattern },
                new FeatureImportance { FeatureName = "Tipo de Metrônomo", Importance = 0.2, Type = FeatureType.Statistical },
                new FeatureImportance { FeatureName = "Posição no Ciclo", Importance = 0.1, Type = FeatureType.Temporal }
            };
        }
        ...
        private void AtualizarEstadoAtual()
        {
            foreach (var metronomo in _metronomos.Values)
            {
                metronomo.AtualizarEstado(ConcursoAlvo);
            }
        }
