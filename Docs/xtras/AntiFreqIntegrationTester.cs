    ...
    public static class AntiFreqIntegrationTester
    {
        ...
        private static async Task<IntegrationTest> TestModelInitialization()
        {
            ...
            try
            {
                ...
                var initResult = await antiFreqModel.InitializeAsync(new Lances(dados));
                ...
                // Treinar modelo
                var trainResult = await antiFreqModel.TrainAsync(new Lances(dados));
                if (!trainResult)
                {
                ...
                test.Success = true;
                test.Details = $"✅ Modelo inicializado";
                return test;
            }
            catch (Exception ex)
            {
        ...
        private static async Task<IntegrationTest> TestEngineIntegration()
        {
            ...
            try
            {
                ...
                var antiFreqModel = new AntiFrequencySimpleModel();
                await antiFreqModel.InitializeAsync(new Lances(dados));
                await antiFreqModel.TrainAsync(new Lances(dados));
        ...
        private static async Task<IntegrationTest> TestPerformanceComparison()
        {
            ...
            try
            {
                ...
                // Inicializar modelos
                await metronomoModel.InitializeAsync(new Lances(dados));
                await metronomoModel.TrainAsync(new Lances(dados));
        ...
        private static async Task<IntegrationTest> TestAntiFrequencyStrategies()
        {
            ...
            try
            {
                ...
                test.Success = true;
                test.Details = $"✅ Estratégias funcionando: {intersection}/15 dezenas comuns.";
                return test;
            }
            catch (Exception ex)
            {
        ...
        private static async Task<IntegrationTest> TestBasicEnsemble()
        {
            ...
            try
            {
                ...
                await engine.InitializeAsync(new Lances(dados));
