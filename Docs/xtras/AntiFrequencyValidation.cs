...
public class AntiFrequencyValidation
{
    ...
    public async Task<ValidationReport> ExecuteFullValidationAsync(Lances historicalData)
    {
        var report = new ValidationReport
        {
            ...
            TestResults = new List<TestResult2>()
        };
    ...
    private async Task<TestResult2> TestModelCreation()
    {
        var result = new TestResult2
        {
    ...
    private async Task<TestResult2> TestModelInitialization(Lances historicalData)
    {
        var result = new TestResult2
        {
    ...
    private async Task<TestResult2> TestModelTraining(Lances historicalData)
    {
        var result = new TestResult2
        {
    ...
    private async Task<TestResult2> TestPredictionGeneration(Lances historicalData)
    {
        var result = new TestResult2
        {
    ...
    private async Task<TestResult2> TestHistoricalValidation(Lances historicalData)
    {
        var result = new TestResult2
        {
    ...
    private async Task<TestResult2> TestParameterConfiguration()
    {
        var result = new TestResult2
        {
    ...
    private async Task<TestResult2> TestComparisonWithMetronomo(Lances historicalData)
    {
        var result = new TestResult2
        {
